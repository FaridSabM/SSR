...
def softmax_bilinear_SR(X, alpha, lr, max_iter, k, tol=1e-6, eps=1e-8):
    """
    Softmax-based Bilinear Self-Representation (softmax-bilinear SR) for
    unsupervised feature selection.

    Minimizes:
        L = ||X - A X B||_F^2 + alpha * ||B||_{2,1}
